...
Christian Szegedy1, Wei Liu2, Yangqing Jia, et al. "Going Deeper with Convolutions"
'''
...
class MxGoogleNet:
	...
	def build(classes):
		...
		conv2_1 = MxGoogLeNet.conv_module(pool1, 64, 1, 1)
		conv2_2 = MxGoogLeNet.conv_module(conv2_1, 192, 3, 3, pad=(1, 1))
		pool2 = mx.sym.Pooling(data=conv2_2, pool_type="max", pad=(1, 1), kernel=(3, 3), stride=(2, 2))
